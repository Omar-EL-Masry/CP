...
struct Mod_int
{
	...
	friend ostream &operator<<(ostream &os, Mod_int x) { return os << x.val; }
	Mod_int() {};
	Mod_int(T _val) { val = (_val + Mod) % Mod; }
	Mod_int operator+(Mod_int rhs) { return Mod_int((this->val + rhs.val) % Mod); }
	...
	Mod_int operator*(Mod_int rhs) { return Mod_int((val * rhs.val) % Mod); }
	...
	friend Mod_int power(Mod_int a, Mod_int b) { return power(a, b.val); }
	Mod_int inv() { return power(Mod_int(val), Mod - 2); }
	Mod_int operator/(Mod_int rhs) { return *this * rhs.inv(); }
	Mod_int &operator+=(Mod_int rhs) { return *this = *this + rhs; }
	Mod_int &operator-=(Mod_int rhs) { return *this = *this - rhs; }
	Mod_int &operator*=(Mod_int rhs) { return *this = *this * rhs; }
	Mod_int &operator/=(Mod_int rhs) { return *this = *this / rhs; }
	bool operator==(Mod_int rhs) { return (val == rhs.val); }
};
